        ...
        <div class="uk-navbar-container cs-navbar-container uk-sticky uk-sticky-fixed">
            ...
            <div id="mobile-nav-menu" class="uk-animation-slide-top uk-hidden@s uk-hidden uk-container uk-container-expand mobile-navigation">
                <ul class="mobile-nav">
                    ...
                    <li v-if="$auth.state.user && $auth.state.user.userType === 'sponsor'">
                        <a href="/sponsor/campaign">
                            <span class="text">Campaigns</span>
                            <span class="after">
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 10.0401 17.9909"
                                    enable-background="new 0 0 10.0401 17.9909" xml:space="preserve">
                                    <path fill="%231d1d1f" fill-rule="evenodd" clip-rule="evenodd" d="M9.6564,8.04c0.5116,0.5277,0.5116,1.3842,0,1.9121l-7.4175,7.6438c-0.5132,0.5267-1.3433,0.5267-1.8545,0c-0.5125-0.5278-0.5125-1.3845,0-1.9124l6.4901-6.6882L0.3844,2.3072c-0.5125-0.5279-0.5125-1.3845,0-1.9124c0.5112-0.5264,1.3413-0.5264,1.8545,0L9.6564,8.04z"
                                    />
                                </svg>
                            </span>
                        </a>
                    </li>
                    <li v-if="$auth.state.user && $auth.state.user.userType === 'influencer'">
                        <a href="/requests">
                            <span class="text">Requests</span>
                            <span class="after">
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 10.0401 17.9909"
                    ...
                    <li v-if="$auth.state.user && $auth.state.user.userType === 'influencer' && $auth.state.user.twitterDetails === null">
                        <a href="/connect/twitter">
                            <span class="text">Connect twitter</span>
                            <span class="after">
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 10.0401 17.9909"
...
export default {
  mounted() {
    ...
    window.drift.load("yx63zxrmv6b9");
  }
};
</script>
